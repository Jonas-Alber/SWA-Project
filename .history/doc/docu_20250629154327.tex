...
\begin{enumerate}
    ...
    \item Basierend auf dieser Analyse instanziiert die Factory ein konkretes Ladeobjekt (z.B. eine Instanz von `PNG_Loader` oder `SVG_Loader`), das eine gemeinsame Schnittstelle (z.B. `DataLoader`) implementiert.
