...
Wie oft und an welcher stelle Checkpoints erzeugt werden ist dabei dem Entwickler überlassen. Im Demobeispiel wird vor jeder Stage welche im Transformer oder Tester bereich ausgeführt wird ein solcher Checkpoint erzeugt. Dadurch kann der Benutzer jederzeit änderungen an beliebigen Teiles der Pipeline vornehmen. Durch das Drücken des Updatebuttons 
