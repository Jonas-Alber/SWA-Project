...
class ListOrderingWidget(QWidget):
    ...
    def is_order_changes(self) -> bool:
        ...
        """
        current_order = [self.list_widget.itemWidget(self.list_widget.item(idx)) for idx in range(self.list_widget.count())]
        return current_order != self.get_ordered_widgets()
