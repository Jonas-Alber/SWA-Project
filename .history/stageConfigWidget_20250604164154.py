...
class _UpdateWorker(QObject):
    finished = Signal()
    def __init__(self, stage, updated):
        super().__init__()
        self.stage = stage
        self.updated = updated
    def run(self):
        # das eigentliche Heavy-Lifting im Worker-Thread
        self.stage.setConfigElements(self.updated)
        self.finished.emit()
...
class  StageConfigWidget(QWidget):
    def __init__(self, stage):
        ...
        self._main_layout.addWidget(save_btn)
    ...
    def _on_save(self):
        ...
        # 2) Starte den Worker-Thread
        self._worker = _UpdateWorker(self._stage, self._updated)
    ...
    def _on_update_finished(self):
        # wird im Haupthread aufgerufen, wenn der Worker fertig ist
        print("Stage-Konfiguration erfolgreich aktualisiert.")
        # hier könntest Du z.B. Buttons re-aktivieren o.Ä.