...
class ArucoMarkerTransformer(AbcImageTransformer):
    def __init__(self, poster_image: Image):
        ...
        """
        self._poster_image = poster_image if isinstance(poster_image, Image) else self._loadDisplayImage(poster_image)
    ...
    def _loadDisplayImage(self, image:str):
        ...
        self._poster_image = Image.open(image).convert("RGB")
        
    def getConfigElements(self):
        return super().getConfigElements()
    
    def setConfigElements(self, config_elements):
